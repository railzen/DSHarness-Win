...
pub use core::{
    ...
    fetch_dsh_pkg_tags, fetch_latest_dsh_pkg_info, fetch_node_sha256, install_official_dsh,
    parse_version_from_tag, record_matches_latest_release, resolve_update, verify_sha256,
